...
font = gui_helpers.create_font()

def menu(
         menu,                          # iterable of str as ("item",) or ("item::tooltip",)
         font1      = font,             # font object|None(pygame default font): unhighlighted item font
         font2      = font,             # font object|None(font1): highlighted item font
         ...
         interline  = 2,                # int: items spacing
         justify    = False,             # boolean
         light      = 5,                # int in range [-10,10]: use if color2 is None
         speed      = 0,              # int (0 = no sliding): anim speed
         lag        = 0,               # int in range [0,90]
         neon       = None,             # boolean: set neon effect
         tooltipfont= font,             # font object|None(pygame default font)
